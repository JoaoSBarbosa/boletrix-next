...
export function Selection({
  ...
  return (
    <div className={styles.selectionContent} style={{ width: width }}>
          ...
          <Select.Portal>
            <Select.Content className={styles.selectContent}>
              <Select.ScrollUpButton className={styles.selectScrollButton}>
                <ArrowLineUp size={20} weight="fill" />
...
export function CompactSelection({
  ...
  return (
    <div className={styles.compactSelectionContent} style={{ width: width }}>
      {title}
      <div className={styles.selectionContainer}>
        <Select.Root {...rest}>
          <Select.Trigger
...
export function convertToSelectionOptions({
  ...
  fieldValue,
  fieldLabel,
}: convertToSelectionOptionsProps): SelectionOptionsProps[] {
                ...
                <Select.Group>
                  ...
                  {optionsList.map((option) => (
                    <Select.Item
                      ...
                      value={option.value}
                    >
                      <Select.ItemIndicator className="w-[35px] h-[35px] flex items-center justify-center">
                        <CheckSquare
                          size={"1vw"}
                          weight="fill"
                          color="#17A589"
